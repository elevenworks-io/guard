...
const { computeFingerprint, auditPathOf, guardHookEntries } = require("../hooks/lib.js");
...
function checkWiring(root) {
  ...
  if (settings && settings.disableAllHooks === true) {
    problems.push(`"disableAllHooks": true in .claude/settings.json — ALLE Hooks sind abgeschaltet, guard läuft nicht.`);
  }
